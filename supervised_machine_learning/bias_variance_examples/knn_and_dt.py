...
plt.scatter(Xtrain, Ytrain, s=50, alpha=0.7, c='blue', label="train target")
plt.scatter(Xtrain, model.predict(Xtrain.reshape(Ntrain, 1)), s=50, alpha=0.7, c='green', label="train model")
...
plt.plot(Xaxis, Yaxis, label="full target")
plt.plot(Xaxis, model.predict(Xaxis.reshape(T, 1)), label="full model")
plt.legend()
plt.show()
